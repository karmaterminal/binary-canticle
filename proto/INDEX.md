...
| `proto/stations-and-streams-v0.2.md` | 🩸 + 🌻 (designed) / 🌿 (captured) | v0.2 substrate / wire-format + station:stream addressing | pressure-test | v0.1 baseline | none (all 6 open questions resolved 2026-06-15) | Initial adapter implementation and contract tests | wire-format compendium / pre-empted design space |
